...
export default function Home(props: IIndexProps) {
  ...
  return (
    <div className={styles.fullbody}>
      ...
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.2/jquery.min.js"  async  />
      <script src="https://cdn.snipcart.com/scripts/2.0/snipcart.js" data-api-key="ZDI1MWZjMjktMmU0My00Y2FkLWI0NjUtZTJiMDQyY2Y3MWQ1NjM4MDI2MjMyNDY4MDU1MTc1" id="snipcart"  async />
